...
import metarScreenshot from "@/assets/metar.png";
import statsScreenshot from "@/assets/stats.png";
import planeScreenshot from "@/assets/plane.png";
import notesScreenshot from "@/assets/notes.png";
import VideoLearn from "@/assets/demo-learning-mode.mp4";
						...
						<div className="grid md:grid-cols-3 gap-6 mt-12">
							...
							>
								...
								<p className="text-sm text-muted-foreground">
									Ucz się w swoim tempie z natychmiastowym feedbackiem i
							...
							>
								...
								<p className="text-sm text-muted-foreground">
									Zadaj pytanie AI jeśli coś jest niejasne - otrzymasz
							...
							>
								...
								<p className="text-sm text-muted-foreground">
									Monitoruj swoje wyniki i zobacz w których obszarach
