      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            >
              Najbardziej kompleksowa platforma do przygotowania do egzaminu PPLA. 
              Tysiące pytań, AI wyjaśnienia i tryb egzaminacyjny.
            </p>
            ...
            >
              <Link to="/auth">
                <Button size="lg" className="text-lg px-8 py-6 h-auto bg-primary hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all hover:scale-105">
      ...
      <section id="features" className="py-24 bg-card/50 backdrop-blur-sm relative">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="p-8 rounded-2xl bg-background border border-border hover:border-primary/50 transition-all hover:shadow-lg hover:-translate-y-2 duration-300 animate-fade-in" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="p-8 rounded-2xl bg-background border border-border hover:border-primary/50 transition-all hover:shadow-lg hover:-translate-y-2 duration-300 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6 transition-transform hover:scale-110 duration-300">
            ...
            <div className="p-8 rounded-2xl bg-background border border-border hover:border-primary/50 transition-all hover:shadow-lg hover:-translate-y-2 duration-300 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6 transition-transform hover:scale-110 duration-300">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-8 rounded-2xl bg-background/80 backdrop-blur-sm border-2 border-primary/30 shadow-lg animate-fade-in hover:scale-105 transition-transform duration-300" style={{ animationDelay: '0.2s' }}>
                <div className="w-16 h-16 rounded-full bg-primary/20 flex items-center justify-center mx-auto mb-4">
                  <Rocket className="h-8 w-8 text-primary" />
                </div>
                <h3 className="text-2xl font-bold mb-3">Wkrótce: ATPL</h3>
                <p className="text-muted-foreground">
                  Przygotowanie do egzaminu ATPL - licencji pilota zawodowego. Rozszerzamy platformę o zaawansowane materiały.
                </p>
              </div>

              <div className="p-8 rounded-2xl bg-background/80 backdrop-blur-sm border-2 border-accent/30 shadow-lg animate-fade-in hover:scale-105 transition-transform duration-300" style={{ animationDelay: '0.4s' }}>
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-8 md:p-12 rounded-3xl border-2 border-primary/20 shadow-xl animate-fade-in hover:shadow-2xl hover:scale-[1.02] transition-all duration-500" style={{ animationDelay: '0.2s' }}>
              <div className="text-center mb-8">
                <div className="inline-block animate-pulse">
                  <span className="text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/60">30 PLN</span>
              ...
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  <li key={index} className="flex items-start gap-3 animate-fade-in" style={{ animationDelay: `${0.3 + index * 0.1}s` }}>
              ...
              <Link to="/auth" className="block">
                <Button size="lg" className="w-full text-lg py-6 h-auto shadow-lg hover:shadow-xl transition-all hover:scale-105 animate-fade-in" style={{ animationDelay: '1s' }}>
