...
const Notes = () => {
	...
	const handleExport = () => {
		...
		const exportFileDefaultName = `notatki_${
				...
				<div className="flex items-center gap-3">
					...
					<div>
						...
						<p className="text-muted-foreground">
							Organizuj swoją wiedzę o lotnictwie
						</p>
					</div>
				</div>
			</div>
					...
					<div className="text-muted-foreground">
						{notes.length === 0 ? (
							<>
								...
								<p className="text-sm">
									Dodaj swoją pierwszą notatkę lotniczą!
								</p>
							</>
						) : (
							<>
											...
											<AlertDialog>
												...
												<AlertDialogContent>
													<AlertDialogHeader>
														...
														<AlertDialogDescription>
															Tej operacji nie można cofnąć. Notatka zostanie
															trwale usunięta.
														</AlertDialogDescription>
													</AlertDialogHeader>
													<AlertDialogFooter>
								...
								<CardContent className="space-y-3">
									<p
										className={`text-sm text-muted-foreground ${
											expandedIds.has(note.id) ? "" : "line-clamp-4"
										}`}
									>
										{note.content}
									</p>
