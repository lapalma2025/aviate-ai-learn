    ...
    <footer className="border-t border-border bg-card/50 backdrop-blur-sm mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/how-to-get-ppla" className="text-muted-foreground hover:text-primary transition-colors">
                  Jak zdobyć PPL(A)?
                </Link>
              </li>
              <li>
                <Link to="/costs-ppla" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <a href="mailto:kontakt@ppla-academy.pl" className="text-primary hover:underline">
        ...
        <div className="mt-8 pt-6 border-t border-border text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} PPLA Academy. Wszelkie prawa zastrzeżone.</p>
        </div>
      </div>
    </footer>
  );
